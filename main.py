...
def covid_getter(message):
    ...
    if int(message_words[1]) in list(studentdata_df['id_number']):
        bot.send_message(message.chat.id,"Thank you for informing us! For everyone's safety will be informing all your classmates of your current condition. Please contact healthservices.ls@ateneo.edu or visit https://bit.ly/LS-OHS if you wish for medical advisment and assistance.")
